...
if __name__ == '__main__':
    ...
    parser.add_argument('-model_pb_dir', type=str, default="./output1/",
                        help='directory of a pretrained BERT model,default = model_dir')
    parser.add_argument('-max_seq_len', type=int, default=128,
                        help='maximum length of a sequence,default:128')
    parser.add_argument('-num_labels', type=int, default=21,
                        help='length of all labels,default=21')
